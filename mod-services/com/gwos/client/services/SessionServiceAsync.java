...
public interface SessionServiceAsync {
	...
	void getUser(String username, String passwd, AsyncCallback<User> async);

	void addUser(User user, AsyncCallback<Boolean> async);
	
	void deleteUser(String username, AsyncCallback<Boolean> async);

	void closeUserConnection(AsyncCallback<Void> async);
